...
import SessionExercise from '../components/train/SessionExercise.jsx';
            ...
            {!state.finishWorkout ? (
                <>
                    ...
                    {state.exercises.map((item) => (
                        <SessionExercise key={item.uniqueId} uniqueId={item.uniqueId} exerciseId={item.exerciseId} exerciseName={item.exerciseName} />
                    ))}
